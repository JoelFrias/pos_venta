...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        $pdf->SetFont('Arial', '', 7);
        $pdf->MultiCell(66, 4, 'Gracias por su pago. Este comprobante es evidencia de su transaccion con YSAPELLI.', 0, 'C');
        
        // Salida del PDF
        $pdf->Output('I', 'Comprobante_YSAPELLI_' . $registro . '.pdf');
    } else {
