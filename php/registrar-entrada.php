...
try {
    ...
    // 2. Registrar la entrada en el historial (tabla inventario_ajustes)
    $sqlHistorial = "INSERT INTO inventario_ajustes 
                    (idProducto, movimiento, cantidad, idEmpleado, fecha, motivo)
                    VALUES (?, 'entrada', ?, ?, NOW(), ?)";
    ...
    $stmtHistorial->bind_param("idss", $id_producto, $cantidad, $usuario, $detalles);
    ...
    // Corregido: usar $stmtTransacciones en lugar de $stmtHistorial y correción de tipos de parámetros
