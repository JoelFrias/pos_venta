  ...
  <div class="container">
    ...
    <script>
        ...
        button.addEventListener("click", function () {
            let parentCard = this.closest(".stat-card");
            let category = parentCard.querySelector("p").textContent.trim(); 

            let filterClass = "";
            if (category === "Casi Agotados") {
                filterClass = "Casi Agotado";
            } else if (category === "No Disponibles") {
                filterClass = "Agotado";
            }

            document.querySelectorAll("#inventarioTable tbody tr").forEach((row) => {
                let statusCell = row.querySelector("td:last-child span").textContent.trim();
                if (statusCell === filterClass) {
                    row.style.display = "";
                } else {
